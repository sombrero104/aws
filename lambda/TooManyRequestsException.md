...
**_지수 백오프에 지터를 사용하면 시간은 더 오래 걸리지만_** <br/>
**_클라이언트 작업량과 서버 부하를 현저히 감소시킨다._** <br/>
<br/>

#### 백오프 + 지터 사용 시 전체 요청 완료 시간 비교 
...
<img src="./images/aws_backoff_simulator_1.png" width="38%" /> <br/><br/>
